...
<script>
	...
	$(window).load(function() {
		function test() {
			let x = document.getElementsByClassName("dd");
			let y = document.getElementsByClassName("ssbutt");
			let z = document.getElementsByClassName("cancel");

			for (let b = 0; b < x.length; b++) {

				y[b].onclick = function() {
					x[b].style.visibility = "visible";
				}

				z[b].onclick = function() {
										...
										<div class="navbar navbar_">
											<div class="navbar-inner navbar-inner_">
												...
												<div class="nav-collapse nav-collapse_ collapse">
													...
													<li><p id="inn">${administrator}${logout}
															<%
											...
											<div class="row">
												<div class="span12">
													<div class="box2">
														<div class="box2_top">
															<h1>
																<span class="fontcolors top">查詢使用者的留言</span>
															</h1>
														</div>
																				...
																				<div class="edit input-group input-group-md">
																					<div class="table-responsive">
																						<table class="table">
																							<thead>
																								<tr>
																									<th class="ff">使用者名稱</th>
																									<th class="ff">使用者的問題類型</th>
																									<th class="ff">使用者的留言</th>
																									<th class="ff">回覆留言</th>
																								</tr>
																							</thead>
																							<tbody>
																								...
																								<tr>
																									<form
																										...
																										method="post">
																										<td class="ff"><textarea class="yesf" readonly><%=request.getAttribute("x" + x)%></textarea></td>
																										<td class="ff"><br><%=request.getAttribute("y" + x)%></td>
																										<td class="ff"><br><%=request.getAttribute("z" + x)%></td>
																										<input type="hidden" name="c"
																											value="<%=request.getAttribute("c" + x)%>">



																										<div class="dd">
																											<textarea id="ddd" name="d"></textarea>

																											<br> <input type="submit"
																												class="w btn btn-secondary" value="回覆">
																									</form>
																									<button class="cancel w btn btn-secondary">取消</button>
																									</div>


																									<td><input type="button" class="ssbutt"
																										value="                 "></td>
